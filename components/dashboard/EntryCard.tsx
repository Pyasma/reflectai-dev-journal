...
const commandTypeColors = {
  development: 'bg-blue-500/20 dark:bg-blue-500/30 text-blue-700 dark:text-blue-300 border-blue-500/40',
  maintenance: 'bg-yellow-500/20 dark:bg-yellow-500/30 text-yellow-700 dark:text-yellow-300 border-yellow-500/40',
  planning: 'bg-purple-500/20 dark:bg-purple-500/30 text-purple-700 dark:text-purple-300 border-purple-500/40',
};
...
export function EntryCard({ entry }: EntryCardProps) {
  ...
  return (
    <Card className="group hover-lift hover:shadow-2xl dark:hover:shadow-[0_20px_60px_rgba(167,139,250,0.3)] transition-all duration-500 hover:border-primary/40 cursor-pointer overflow-hidden">
      ...
      <CardContent className="relative z-10">
        ...
        {entry.ai_technical_details && (
          <div className="mb-4 animate-fade-in-up animation-delay-100">
            ...
            <div
              className="text-sm line-clamp-4 prose prose-sm max-w-none dark:prose-invert"
          ...
          <div className="flex gap-2">
            <Link href={`/dashboard/edit/${entry.id}`}>
              <Button 
                variant="outline" 
                size="sm"
                className="hover-scale hover:shadow-lg hover:border-primary/50 dark:hover:shadow-[0_0_20px_rgba(167,139,250,0.3)] transition-all duration-300"
              >
